...
| RuntimeMode intervals: slow=30min, default=1min, steady=5min, turbo=45s | `02_runtime/creative_metabolism.md §1` | `runtime-config.ts` → `getIntervalMs`: slow=`30*60*1000`, default=`60*1000`, steady=`5*60*1000`, turbo=`45*1000` | **VERIFIED IN CODE** | |
